...
public class VerifyCartAmount {
        ...
        @FindBy(xpath = "(//li//label)[1]")private WebElement CartAmount;

        public VerifyCartAmount(WebDriver driver) {
        ...
        public double getOrderAmount() {
            ...
            return Double.parseDouble(OrderAmount.getText());
        }
